...
apple = Stock.create(company_name: "Apple Inc", symbol:"AAPL", day_open_price:295.06, current_price: 300.92)
disney = Stock.create(company_name:"The Walt Disney Company", symbol: "DIS", day_open_price: 101.51, current_price: 101.38)
netflix = Stock.create(company_name:"Netflix,Inc", symbol:"NFLX", day_open_price: 427.55, current_price:428.61)
...
t4 = Transaction.create(user:u1, stock:apple, quantity: 5, sale_type:"sell", sale_price:300.92, sale_total:(300.92*5))